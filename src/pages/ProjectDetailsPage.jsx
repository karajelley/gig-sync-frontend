...
function ProjectDetailsPage() {
  ...
  const { API_URL, clients, isEditing, setIsEditing, fetchData } =
  ...
  const fetchProjectDetails = async () => {
    try {
      ...
      setProject(response.data); // Save the project details
          ...
          <Box sx={{ marginTop: 4 }}>
            ...
            <Box sx={{ mt: 4 }}>
              ...
              <Typography variant="body2" sx={{ mb: 2 }} gutterBottom>
                ⚠️ This will delete the client and all projects associated with
